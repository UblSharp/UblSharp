...
namespace UblSharp
{
    ...
    public partial class TransportServiceDescriptionType : BaseDocument, IBaseDocument
    {
        ...
        public TransportationServiceType[] @__TransportationService
        {
            get
            {
                return TransportationService?.ToArray();
            }
            set
            {
                TransportationService = value == null ? null : new System.Collections.Generic.List<TransportationServiceType>(value);
            }
        }
        ...
        /// </summary>
        [System.Xml.Serialization.XmlIgnoreAttribute]
        public System.Collections.Generic.List<TransportationServiceType> TransportationService { get; set; }
