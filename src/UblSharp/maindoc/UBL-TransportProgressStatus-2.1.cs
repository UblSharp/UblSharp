...
namespace UblSharp
{
    ...
    public partial class TransportProgressStatusType : BaseDocument, IBaseDocument
    {
        ...
        public TransportScheduleType[] @__TransportSchedule
        {
            get
            {
                return TransportSchedule?.ToArray();
            }
            set
            {
                TransportSchedule = value == null ? null : new System.Collections.Generic.List<TransportScheduleType>(value);
            }
        }
        ...
        /// </summary>
        [System.Xml.Serialization.XmlIgnoreAttribute]
        public System.Collections.Generic.List<TransportScheduleType> TransportSchedule { get; set; }
