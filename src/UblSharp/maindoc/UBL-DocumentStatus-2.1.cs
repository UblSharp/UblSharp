...
namespace UblSharp
{
    ...
    public partial class DocumentStatusType : BaseDocument, IBaseDocument
    {
        ...
        public DocumentResponseType[] @__AdditionalDocumentResponse
        {
            get
            {
                return AdditionalDocumentResponse?.ToArray();
            }
            set
            {
                AdditionalDocumentResponse = value == null ? null : new System.Collections.Generic.List<DocumentResponseType>(value);
            }
        }
        ...
        /// </summary>
        [System.Xml.Serialization.XmlIgnoreAttribute]
        public System.Collections.Generic.List<DocumentResponseType> AdditionalDocumentResponse { get; set; }
