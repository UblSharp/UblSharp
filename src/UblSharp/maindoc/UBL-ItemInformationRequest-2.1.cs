...
namespace UblSharp
{
    ...
    public partial class ItemInformationRequestType : BaseDocument, IBaseDocument
    {
        ...
        public ItemInformationRequestLineType[] @__ItemInformationRequestLine
        {
            get
            {
                return ItemInformationRequestLine?.ToArray();
            }
            set
            {
                ItemInformationRequestLine = value == null ? null : new System.Collections.Generic.List<ItemInformationRequestLineType>(value);
            }
        }
        ...
        /// </summary>
        [System.Xml.Serialization.XmlIgnoreAttribute]
        public System.Collections.Generic.List<ItemInformationRequestLineType> ItemInformationRequestLine { get; set; }
