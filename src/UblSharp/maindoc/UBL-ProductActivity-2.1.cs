...
namespace UblSharp
{
    ...
    public partial class ProductActivityType : BaseDocument, IBaseDocument
    {
        ...
        public ActivityDataLineType[] @__SupplyChainActivityDataLine
        {
            get
            {
                return SupplyChainActivityDataLine?.ToArray();
            }
            set
            {
                SupplyChainActivityDataLine = value == null ? null : new System.Collections.Generic.List<ActivityDataLineType>(value);
            }
        }
        ...
        /// </summary>
        [System.Xml.Serialization.XmlIgnoreAttribute]
        public System.Collections.Generic.List<ActivityDataLineType> SupplyChainActivityDataLine { get; set; }
