...
namespace UblSharp
{
    ...
    public partial class CatalogueType : BaseDocument, IBaseDocument
    {
        ...
        public TradingTermsType[] @__TradingTerms
        {
            get
            {
                return TradingTerms?.ToArray();
            }
            set
            {
                TradingTerms = value == null ? null : new System.Collections.Generic.List<TradingTermsType>(value);
            }
        }
        ...
        public CatalogueLineType[] @__CatalogueLine
        {
            get
            {
                return CatalogueLine?.ToArray();
            }
            set
            {
                CatalogueLine = value == null ? null : new System.Collections.Generic.List<CatalogueLineType>(value);
            }
        }
        ...
        /// </summary>
        [System.Xml.Serialization.XmlIgnoreAttribute]
        public System.Collections.Generic.List<TradingTermsType> TradingTerms { get; set; }
        ...
        /// </summary>
        [System.Xml.Serialization.XmlIgnoreAttribute]
        public System.Collections.Generic.List<CatalogueLineType> CatalogueLine { get; set; }
