...
namespace UblSharp
{
    ...
    public partial class AttachedDocumentType : BaseDocument, IBaseDocument
    {
        ...
        public LineReferenceType[] @__ParentDocumentLineReference
        {
            get
            {
                return ParentDocumentLineReference?.ToArray();
            }
            set
            {
                ParentDocumentLineReference = value == null ? null : new System.Collections.Generic.List<LineReferenceType>(value);
            }
        }
        ...
        /// </summary>
        [System.Xml.Serialization.XmlIgnoreAttribute]
        public System.Collections.Generic.List<LineReferenceType> ParentDocumentLineReference { get; set; }
