...
namespace UblSharp
{
    ...
    public partial class OrderResponseSimpleType : BaseDocument, IBaseDocument
    {
        ...
        public TextType[] @__RejectionNote
        {
            get
            {
                return RejectionNote?.ToArray();
            }
            set
            {
                RejectionNote = value == null ? null : new System.Collections.Generic.List<TextType>(value);
            }
        }
        ...
        [System.Xml.Serialization.XmlIgnoreAttribute]
        public System.Collections.Generic.List<TextType> RejectionNote { get; set; }
