...
namespace UblSharp
{
    ...
    public partial class InventoryReportType : BaseDocument, IBaseDocument
    {
        ...
        public InventoryReportLineType[] @__InventoryReportLine
        {
            get
            {
                return InventoryReportLine?.ToArray();
            }
            set
            {
                InventoryReportLine = value == null ? null : new System.Collections.Generic.List<InventoryReportLineType>(value);
            }
        }
        ...
        /// </summary>
        [System.Xml.Serialization.XmlIgnoreAttribute]
        public System.Collections.Generic.List<InventoryReportLineType> InventoryReportLine { get; set; }
