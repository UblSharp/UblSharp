...
namespace UblSharp
{
    ...
    public partial class TendererQualificationResponseType : BaseDocument, IBaseDocument
    {
        ...
        public QualificationResolutionType[] @__QualificationResolution
        {
            get
            {
                return QualificationResolution?.ToArray();
            }
            set
            {
                QualificationResolution = value == null ? null : new System.Collections.Generic.List<QualificationResolutionType>(value);
            }
        }
        ...
        /// </summary>
        [System.Xml.Serialization.XmlIgnoreAttribute]
        public System.Collections.Generic.List<QualificationResolutionType> QualificationResolution { get; set; }
