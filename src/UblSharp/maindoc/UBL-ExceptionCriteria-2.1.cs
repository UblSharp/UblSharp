...
namespace UblSharp
{
    ...
    public partial class ExceptionCriteriaType : BaseDocument, IBaseDocument
    {
        ...
        public ExceptionCriteriaLineType[] @__ExceptionCriteriaLine
        {
            get
            {
                return ExceptionCriteriaLine?.ToArray();
            }
            set
            {
                ExceptionCriteriaLine = value == null ? null : new System.Collections.Generic.List<ExceptionCriteriaLineType>(value);
            }
        }
        ...
        /// </summary>
        [System.Xml.Serialization.XmlIgnoreAttribute]
        public System.Collections.Generic.List<ExceptionCriteriaLineType> ExceptionCriteriaLine { get; set; }
