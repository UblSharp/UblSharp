...
namespace UblSharp
{
    ...
    public partial class RetailEventType : BaseDocument, IBaseDocument
    {
        ...
        public EventCommentType[] @__EventComment
        {
            get
            {
                return EventComment?.ToArray();
            }
            set
            {
                EventComment = value == null ? null : new System.Collections.Generic.List<EventCommentType>(value);
            }
        }
        ...
        /// </summary>
        [System.Xml.Serialization.XmlIgnoreAttribute]
        public System.Collections.Generic.List<EventCommentType> EventComment { get; set; }
