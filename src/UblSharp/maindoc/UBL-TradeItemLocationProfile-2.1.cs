...
namespace UblSharp
{
    ...
    public partial class TradeItemLocationProfileType : BaseDocument, IBaseDocument
    {
        ...
        public ItemManagementProfileType[] @__ItemManagementProfile
        {
            get
            {
                return ItemManagementProfile?.ToArray();
            }
            set
            {
                ItemManagementProfile = value == null ? null : new System.Collections.Generic.List<ItemManagementProfileType>(value);
            }
        }
        ...
        /// </summary>
        [System.Xml.Serialization.XmlIgnoreAttribute]
        public System.Collections.Generic.List<ItemManagementProfileType> ItemManagementProfile { get; set; }
