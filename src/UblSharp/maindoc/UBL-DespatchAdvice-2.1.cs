...
namespace UblSharp
{
    ...
    public partial class DespatchAdviceType : BaseDocument, IBaseDocument
    {
        ...
        public DespatchLineType[] @__DespatchLine
        {
            ...
            set
            {
                DespatchLine = value == null ? null : new System.Collections.Generic.List<DespatchLineType>(value);
            }
        }
        ...
        /// </summary>
        [System.Xml.Serialization.XmlIgnoreAttribute]
        public System.Collections.Generic.List<DespatchLineType> DespatchLine { get; set; }
